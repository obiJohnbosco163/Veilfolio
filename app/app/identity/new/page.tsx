        ...
        <div className="bg-card border border-card-border rounded-2xl p-6 sm:p-8 animate-fade-in-up">
          ...
          <div className="flex justify-between mt-8 pt-6 border-t border-card-border">
            <button
              ...
              className="px-5 py-2.5 border border-card-border rounded-xl font-medium text-muted hover:text-foreground hover:bg-surface disabled:opacity-30 disabled:cursor-not-allowed transition-colors text-sm"
            >
            ...
            <div className="flex gap-3 items-center">
              ...
              {step === 4 ? (
                ...
                <button
                  onClick={() => { sfx.step(); setStep(step + 1); }}
